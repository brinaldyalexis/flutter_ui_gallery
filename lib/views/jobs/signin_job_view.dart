...
class SigInJobView extends StatelessWidget {
  const SigInJobView({super.key});
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Theme(
                          ...
                          child: TextButton(
                            onPressed: () {
                              // Navigate to Recovery Password View
                              debugPrint('Forgot password button pressed');
                              context.push('/jobs/recovery-password');
                            },
